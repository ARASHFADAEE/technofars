        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="about__text">
                    <span>تیم مگا پد</span>
                    <h2>درباره ما</h2>
                    <p>از گوش دادن به پادکست های ما لذت می برید؟ با اهدای یک مبلغ ما را حمایت کنید!</p>
                    <a href="#" class="primary-btn">پرداخت آنلاین</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="about__item">
                    <h6>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.
                    </h6>
